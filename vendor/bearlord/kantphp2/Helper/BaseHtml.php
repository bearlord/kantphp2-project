...
use Kant\Validators\StringValidator;
...
class BaseHtml
{
    ...
    {
        return htmlspecialchars($content, ENT_QUOTES | ENT_SUBSTITUTE, Kant::$app ? Kant::$app->charset : 'UTF-8', $doubleEncode);
    }
     ...
     * @param string $content
     *            the content to be enclosed between the start and end tags. It will not be HTML-encoded.
     *            If this is coming from end users, you should consider [[encode()]] it to prevent XSS attacks.
     * @param array $options
     *            the HTML tag attributes (HTML options) in terms of name-value pairs.
     ...
     * 
     * @param string $text
     *            link body. It will NOT be HTML-encoded. Therefore you can pass in HTML code
     ...
     *            it to prevent XSS attacks.
     * @param string $email
     *            email address. If this is null, the first parameter (link body) will be treated
     ...
     * 
     * @param string $content
     *            label text. It will NOT be HTML-encoded. Therefore you can pass in HTML code
     ...
     * 
     * @param string $content
     *            the content enclosed within the button tag. It will NOT be HTML-encoded.
     ...
     *            the value attribute. If it is null, the value attribute will not be generated.
     * @param array $options
     *            the attributes of the button tag. The values will be HTML-encoded using [[encode()]].
     ...
     *            the selected value(s).
     * @param array $items
     *            the data item used to generate the checkboxes.
     *            The array keys are the checkbox values, while the array values are the corresponding labels.
     * @param array $options
     *            options (name => config) for the checkbox list container tag.
     ...
     *            the selected value(s).
     * @param array $items
     *            the data item used to generate the radio buttons.
     *            The array keys are the radio button values, while the array values are the corresponding labels.
     * @param array $options
     *            options (name => config) for the radio button list container tag.
     *            The following options are specially handled:
     *            
     ...
     *            about attribute expression.
     * @param array $options
     *            the tag options in terms of name-value pairs. The values will be HTML-encoded
     ...
     *            about attribute expression.
     * @param array $items
     *            the data item used to generate the input fields.
     ...
     * 
     * @param string|array $selection
     *            the selected value(s). This can be either a string for single selection
     ...
     *            the $options parameter that is passed to the [[dropDownList()]] or [[listBox()]] call.
    ...
    public static function renderSelectOptions($selection, $items, &$tagOptions = [])
    {
        ...
        if (isset($tagOptions['prompt'])) {
            ...
            $lines[] = static::tag('option', $prompt, [
                'value' => ''
            ]);
        }
     ...
     *            the new style string (e.g. `'width: 100px; height: 200px'`) or
     *            array (e.g. `['width' => '100px', 'height' => '200px']`).
     * @param boolean $overwrite
     *            whether to overwrite existing CSS properties if the new style
     *            contain them too.
     * @see removeCssStyle()
     ...
     *            the CSS properties to be removed. You may use a string
     ...
     *
     * @param array $style
     *            the CSS style array. The array keys are the CSS property names,
